...
function spanClick(type, flavor) {
    ...
    function addIceCream(color) {
        ...
        iceCream.style.top = `${30 + (container.childElementCount * 60)}px`; // Positionierung der Eiskugel
    ...
    function addSyrup(color) {
        ...
        syrup.style.top = `${30 + (container.childElementCount * 20)}px`; // Positionierung der Soße
    ...
    function addTopping(color) {
        ...
        topping.style.top = `${30 + (container.childElementCount * 30)}px`; // Positionierung des Toppings
    ...
    if (type === 'iceCream') {
        if (flavor === 'vanilla') addIceCream('#ffffe0');
        if (flavor === 'chocolate') addIceCream('#3e2723');
        if (flavor === 'strawberry') addIceCream('#ffc0cb');
    }

    // Beispiel für verschiedene Soßen
    if (type === 'syrup') {
        if (flavor === 'chocolate') addSyrup('#3e2723');
        if (flavor === 'caramel') addSyrup('#ffeb3b');
        if (flavor === 'strawberry') addSyrup('#ffc0cb');
    }

    // Beispiel für verschiedene Toppings
    if (type === 'topping') {
        if (flavor === 'sprinkles') addTopping('#ffeb3b');
        if (flavor === 'nuts') addTopping('#8d6e63');
        if (flavor === 'chocolate') addTopping('#3e2723');
    }
}
    ...
    if (type === 'iceCream') {
        if (flavor === 'vanilla') addIceCream('#ffffe0');
        else if (flavor === 'chocolate') addIceCream('#3e2723');
        else if (flavor === 'strawberry') addIceCream('#ffc0cb');
    }

    // Beispiel für verschiedene Soßen
    if (type === 'syrup') {
        if (flavor === 'chocolate') addSyrup('#3e2723');
        else if (flavor === 'caramel') addSyrup('#ffeb3b');
        else if (flavor === 'strawberry') addSyrup('#ffc0cb');
    }

    // Beispiel für verschiedene Toppings
    if (type === 'topping') {
        if (flavor === 'sprinkles') addTopping('#ffeb3b');
        else if (flavor === 'nuts') addTopping('#8d6e63');
        else if (flavor === 'chocolate') addTopping('#3e2723');
    }
